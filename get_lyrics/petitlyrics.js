var lyrics=document.getElementById("lyrics").innerHTML.replace(/<br>/g, "").replace(/&amp;/g, "&");
var title=document.getElementsByClassName('title-bar')[0].innerHTML;
...
var parentObject = document.getElementsByClassName("footer_menu")[0];
